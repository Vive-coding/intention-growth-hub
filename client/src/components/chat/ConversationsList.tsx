                ...
                <button
                  ...
                  onClick={async (e) => {
                    ...
                    try {
                      ...
                      await queryClient.cancelQueries({ queryKey: ["/api/chat/threads", t.id, "messages"] });
                      await queryClient.removeQueries({ queryKey: ["/api/chat/threads", t.id, "messages"], exact: true });
